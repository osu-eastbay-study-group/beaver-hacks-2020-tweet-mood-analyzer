...
* Images
#+CAPTION: Page for Parent tweet / Splash Page
[[file:FrontEnd_NonCode/UI_Drafts/BeaverHacks_Dots_ParentMainPage__Kyle.png]]

#+CAPTION: Focus on a child tweet
[[file:FrontEnd_NonCode/UI_Drafts/BeaverHacks_Dots_ChildFocusPage__Ryan.png]]

#+CAPTION: Example colors for moods
[[file:FrontEnd_NonCode/BeaverHacks_HexCodeChart.png]]
